...
void slow_sweep(T, size_t Dim : 3, Color color)(in Slice!(T*, 3) F, Slice!(T*, 3) U, in T h2)
{
    ...
    auto strideU = U[2 .. m-1, 1 .. n-1, 1 + color .. o -1].strided!(0,1)(2,2);
    strideU[] = U[1 .. m - 2, 1 .. n - 1, 1 + color .. o - 1].strided!(0,1)(2,2);
    strideU[] += U[3..m, 1..n - 1, 1 + color..o - 1].strided!(0,1)(2,2);
    strideU[] += U[2..m - 1, 0..n - 2, 1 + color..o - 1].strided!(0,1)(2,2);
    strideU[] += U[2..m - 1, 2..n, 1 + color..o - 1].strided!(0,1)(2,2);
    strideU[] += U[2..m - 1, 1..n - 1, color..o - 2].strided!(0,1)(2,2);
    strideU[] += U[2..m - 1, 1..n - 1, 2 + color..o].strided!(0,1)(2,2);
    strideU[] -= F[2..m - 1, 1..n - 1, 1 + color..o - 1].strided!(0,1)(2,2) * h2;
    strideU[] /= cast(T) 6;
}
